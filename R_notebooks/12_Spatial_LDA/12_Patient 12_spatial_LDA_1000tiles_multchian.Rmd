...
# Apply Spatial LDA for 2 chain for 4000 iterations (warmup = 500)
## Apply Spatial LDA 
```{r}
...
```{r save_slda}
save(fit_12, fit_12, file = "/Users/cuixinyue/Desktop/TNBC_analysis/Output/RData/Spatial_LDA_results/slda_lda_tile_4000_chain_2_patient_12.RData")
```
