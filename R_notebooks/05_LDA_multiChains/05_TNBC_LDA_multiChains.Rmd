...
load(file = here("Output","RData","02_TNBC_spe_LC.rds"))
spe
```
...
We want to create the Document-Term matrix of the data set where the rows are the sample identity and columns are the cell types fill with counts. The expected dimension of the DTM is 39 rows by 16 columns.
...
lda_file = "JABES_Endo_all_K_5_ite_500.RData"
...
```{r}
source(here::here("R_notebooks", "06_LDA_scripts", "06_modelAssessment.R"))
